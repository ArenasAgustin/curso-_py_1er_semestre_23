...
print("Al cabo de {0} meses, su capital final es de ${1:.2f}. Ud obtuvo ${2:.2f} de ganancia con una tasa de {3:.2%}".format(
    periodoTiempo, capitalFinal, (capitalFinal-capitalInicial), TASAINTERES))
...
print('\t\t Bienvenido al calculador de interes v.0.1 \t\t')
capitalInicial = float(input('Por favor, ingrese su capital inicial: '))
cantidadDeVecesAplicadas = int(
    input('Por favor, ingrese el numero de veces que el interes se aplica: '))
cantidadDeAños = int(input('¿Por cuantos años va a depositar su dinero? '))
capitalFinal = capitalInicial * (1+TASAINTERES/cantidadDeVecesAplicadas)**(cantidadDeVecesAplicadas*cantidadDeAños)
print("Al cabo de n años con un periodo {0}, su capital final es de ${1:.2f}. Ud obtuvo ${2:.2f} de ganancia con una tasa de {3:.2%}".format(
    cantidadDeAños, capitalFinal, (capitalFinal-capitalInicial), TASAINTERES))
